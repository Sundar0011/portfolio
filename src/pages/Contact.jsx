  ...
  return (
    <div>
      ...
      <div className=' grid grid-rows-2 md:p-10'>
        <div data-aos='fade-up' className=' text-white p-5 font-audiowide flex justify-center text-center'>
        ...
        <div data-aos="fade-up" className='grid md:grid-cols-2 '>
            <div className='m-2 border border-green-400 rounded-md grid grid-cols-10 w-auto h-auto '>
                ...
                <div className='text-white font-orbitron flex items-center max-sm:text-[12px]'>
                    9003985212
                </div>
            </div>
            <div data-aos="fade-up"  className=' m-2 border border-green-400 rounded-md grid grid-cols-10 w-auto h-auto '>
                <div className=' col-span-2  flex justify-center items-center  '>
                <FaLinkedin  className=' text-blue-800 bg-transparent h-10 w-10 border-2 border-green-400 rounded-[50%]' />
                </div>
                <div className='col-span-8 text-white font-orbitron flex items-center max-sm:text-[12px] w-auto h-auto'>
